...
public class DefaultTemplateName implements TemplateName
{
    ...
    private DefaultTemplateName(String name, Locale locale)
    {
        this.name = name;
        this.locale = locale;
    }
    ...
    public boolean equals(Object obj)
    {
        ...
        final DefaultTemplateName other = (DefaultTemplateName) obj;
    ...
    {
        return new DefaultTemplateName(name, locale);
    }
